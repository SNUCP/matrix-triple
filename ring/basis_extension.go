...
func ModUpExact(p1, p2 [][]uint64, ringQ, ringP *Ring, params ModupParams) {
	...
	var v [8]uint64
	var y0, y1, y2, y3, y4, y5, y6, y7 [128]uint64
...
func reconstructRNS(index, x int, p [][]uint64, v *[8]uint64, y0, y1, y2, y3, y4, y5, y6, y7 *[128]uint64, Q, QInv, QbMont []uint64) {
...
// Caution, returns the values in [0, 2q-1]
func multSum(res, v *[8]uint64, y0, y1, y2, y3, y4, y5, y6, y7 *[128]uint64, nbPi int, pj, qInv uint64, vtimesqmodp, qoverqimodp []uint64) {
